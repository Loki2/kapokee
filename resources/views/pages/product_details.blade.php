					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2>Product Name: {{$product_by_details->product_name}}</h2>
								<p>Color: {{$product_by_details->product_color}}</p>
								<img src="{{URL::to('frontend/images/product-details/rating.png')}}" alt="" style="weight:100%; height:100%;" />
								<span>
                    ...
                    <div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li><a href="#details" data-toggle="tab">Feature</a></li>
								<li><a href="#tag" data-toggle="tab">Space</a></li>
