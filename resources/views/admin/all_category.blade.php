	...
	<div class="row-fluid sortable">		
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon user"></i><span class="break"></span> ປະເພດສິນຄ້າທັງໝົດ </h2>
				<div class="box-icon">
					<a href="#" class="btn-setting"><i class="hafling-icon wrench"></i></a>
					<a href="#" class="btn-minimize"><i class="hafling-icon chevon-up"></i></a>
					<a href="#" class="btn-close"><i class="hafling-icon remove"></i></a>
				</div>
			</div>
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					<thead>
						<tr>
							...
							<th>ອະທິບາຍກ່ຽວກັບປະເພດສິນຄ້າ</th>
							<th>ສະຖານະ</th>
							<th>Actions</th>
						</tr>
					</thead>  
					...
					<tbody>
						<tr>
							...
							<td class="center">{{$v_category->public_status}}</td>
							<td class="center">
