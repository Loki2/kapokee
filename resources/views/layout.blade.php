...
<body>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +32 028222732 </a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> rixnickl2@gmail.com </a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="#"><i class="fa fa-user"></i> ບັນຊີ </a></li>
								<li><a href="#"><i class="fa fa-star"></i> Wishlist </a></li>
    <!-- I am failed here with checkout system was not check customer ID****************************** -->
						...
						?>
							<?php if($customer_id != NULL && $shipping_id == NULL ) {?>
								...
								<?php }if($customer_id != NULL && $shipping_id != NULL) {?>
									...
									<?php } ?>
								<li><a href="{{URL::to('/show-cart')}}"><i class="fa fa-shopping-cart"></i> ກະຕາຂີເຫຍື່ອ </a></li>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="{{URL::to('/show-cart')}}">Product Details</a></li> 
	...
	<!-- Select Slider Image from Database  -->
	@yield('slider');
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © 2018 Nextech. All rights reserved.</p>
					<p class="pull-right">Designed by <span><a target="_blank" href="http://www.themeum.com">Loki</a></span></p>
				</div>
			</div>
		</div>
